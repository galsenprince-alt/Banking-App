  ...
  await tryCreate("users", () =>
    databases.createCollection({
      ...
      attributes: [
        ...
        { key: "address1",          type: "string",  size: 256, required: false },
        { key: "city",              type: "string",  size: 100, required: false },
        { key: "state",             type: "string",  size: 2,   required: false },
        { key: "postalCode",        type: "string",  size: 10,  required: false },
        { key: "dateOfBirth",       type: "string",  size: 20,  required: false },
        { key: "ssn",               type: "string",  size: 20,  required: false },
        { key: "dwollaCustomerId",  type: "string",  size: 100, required: false },
        { key: "dwollaCustomerUrl", type: "string",  size: 512, required: false },
      ],
      indexes: [
